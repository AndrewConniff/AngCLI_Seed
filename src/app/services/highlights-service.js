...
var HighlightsService = (function () {
    ...
    function HighlightsService(_http) {
        this._http = _http;
        this._url = 'http://localhost:8080/highlights'; // Add a url here to download something or load a .json file to mock results
        // not a really good example
        // this.data = this.getHighlights();
    }
    HighlightsService.prototype.getHighlights = function () {
